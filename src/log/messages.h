...
LOG_SET_MSG(iNameAndVersion,					"FBX to G3Dx converter (ArchVR Edition), version %d.%02d.%04d x%d %s, FBXSDK %d.%02d")
...
LOG_SET_MSG(wSourceConvertFbxExceedsIndices,	"Mesh %s contains more indices (%d) than the specified maximum (%d)")
